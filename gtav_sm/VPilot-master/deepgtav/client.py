...
class Targets:
    ...
    def parse(self, frame, jsonstr):
        try:
            ...
            return None
        #print("dct1:",dct['lane_cpoint'])#test kong
        dct['frame'] = frame
        #print("dct:",dct["location"])#test kong
...
class Client:
    ...
    def sendMessage(self, message):
        ...
        try:
            ...
            print("client.py sendMessage jsonstr:",jsonstr)
            self.s.sendall(struct.pack("i",len(jsonstr)))#python2 by kong
