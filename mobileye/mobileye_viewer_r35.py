...
def setup_listener(node):
    node.create_reader('/apollo/sensor/mobileye',mobileye_pb2.Mobileye, mobileye_callback)
    node.create_reader(PLANNING_TOPIC,
                       planning_pb2.ADCTrajectory,
                       planning_callback)
    node.create_reader('/apollo/localization/pose',
                       localization_pb2.LocalizationEstimate,
                       localization_callback)
    node.create_reader('/apollo/canbus/chassis', chassis_pb2.Chassis, chassis_callback)
    node.create_reader('/apollo/navigation', navigation_pb2.NavigationInfo, routing_callback)
